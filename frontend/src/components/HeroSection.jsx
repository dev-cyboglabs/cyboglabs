...
const HeroSection = () => {
  ...
  const displayProgress = Math.min(Math.round(drawProgress * 100), 100);
  ...
  return (
    <div ref={containerRef} className="relative" style={{ height: '200vh' }}>
      ...
      <section 
        ref={sectionRef}
        className="sticky top-0 min-h-screen flex items-center overflow-hidden bg-neutral-50"
      >
        ...
        {/* Scroll Indicator */}
        <button
          onClick={isComplete ? scrollToNext : undefined}
        ...
        >
          <span className="text-xs uppercase tracking-widest font-mono">
            {isComplete ? 'Continue scrolling' : 'Scroll to draft'}
          </span>
          <ChevronDown 
            size={20} 
        ...
        {/* Progress hint on sides */}
        {!isComplete && (
          <>
            <div className="absolute left-4 top-1/2 -translate-y-1/2 hidden lg:block">
              <div className="h-32 w-1 bg-neutral-200 rounded-full overflow-hidden">
                <div 
                  className="w-full bg-neutral-400 rounded-full transition-all duration-100"
